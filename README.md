...
<p align="center">
  <img src="assets/Dashboard Screenshot" alt="TaskVerse Dashboard" width="800">
</p>


🌟 FeaturesTask 

CRUD Operations: Seamlessly add, view, edit, and delete tasks.
...
📖 UsageAdd a Task: Click the "Add Task" button, fill in the task details (Title, Description, Due Date, Priority), and save.

Mark as Complete: Click the checkmark/checkbox icon to toggle a task's status.

Edit/Delete: Use the edit icon to modify existing tasks or the trash icon to remove them.
